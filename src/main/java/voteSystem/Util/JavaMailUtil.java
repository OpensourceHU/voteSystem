...
public class JavaMailUtil {
    ...
    // 发件人的邮箱-修改为自己的
    public static String emailAccount = "1719423645@qq.com";

    // 发件人邮箱授权码-修改为自己的
    public static String emailPassword = "vlswovrcnwahedia";
    ...
    public static  MimeMessage creatMimeMessage(Session session,String sendMail,String receiveMail,String html) throws MessagingException, IOException {
        ...
        // 2、From：发件人
        message.setFrom(new InternetAddress(sendMail, "OpensourceHU", "UTF-8"));
        // 3、To:收件人（可以增加多个收件人：抄送或者密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "Register", "UTF-8"));
        // 4、Subject:邮件主题
