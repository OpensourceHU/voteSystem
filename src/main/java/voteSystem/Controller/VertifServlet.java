 ...
 * @date 2020/8/8 0008 10:02
 */
@Controller
public class VertifServlet extends HttpServlet {
    ...
    public void VerificationServlet(HttpServletRequest request,HttpServletResponse response) throws IOException {
